...
/*| Vedúci práce: doc. Ing. Miloš Drutarovský, CSc. |*/
...
#define ANONYMOUS_EAP_IDENTITY "anonymous@tuke.sk" //-login@tuke.sk
#define EAP_IDENTITY "mc364ve@tuke.sk" //-login@tuke.sk
#define EAP_PASSWORD "sunavec" //heslo pouzivatela
...
void setup() { //cast setupu prebieha iba raz
  ...
  esp_wifi_sta_wpa2_ent_set_identity((uint8_t *)ANONYMOUS_EAP_IDENTITY, strlen(ANONYMOUS_EAP_IDENTITY)); //nastavenie identity
...
void loop() {
  ...
  delay(250); //pockaj 2 sekundy pred novou sluckou
}
